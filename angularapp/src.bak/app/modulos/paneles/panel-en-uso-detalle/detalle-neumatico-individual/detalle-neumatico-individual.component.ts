...
@Component({
    selector: 'app-detalle-neumatico-individual',
    templateUrl: './detalle-neumatico-individual.component.html',
    styleUrls: ['./detalle-neumatico-individual.component.scss']
})
export class DetalleNeumaticoIndividualComponent implements OnInit {
